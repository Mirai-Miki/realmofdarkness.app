...
export class Vampire5th extends Character5th {
  ...
  get humanity(): number { return this._humanity; }
  get stains(): number { return this._stains; }
  get bloodPotency(): number { return this._bloodPotency; }
  ...
  serialize(): Vampire5thData {
    return {
      ...
      disciplines: Array.from(this._disciplines.values()).map(d => d.serialize()),
...
export class CharacterMapper {
   ...
   */
  static fromDomain(character: Character): Omit<CharacterDb, 'id' | 'createdAt' | 'lastUpdated'> {
    return {
      name: character.name,
