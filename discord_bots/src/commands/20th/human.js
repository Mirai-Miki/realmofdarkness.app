...
module.exports = {
  ...
  async execute(interaction) {
    ...
    switch (interaction.options.getSubcommand()) {
      case "new":
        return await tracker.new(interaction, Splats.human20th);
      case "update":
        return await tracker.update(interaction, Splats.human20th);
      case "set":
        return await tracker.set(interaction, Splats.human20th);
    }
  },

  async autocomplete(interaction) {
    return await autocomplete20th(interaction, Splats.human20th.slug);
  },
};
...
function getCommands() {
  ...
  slashCommand.setName("human").setDescription(".");
