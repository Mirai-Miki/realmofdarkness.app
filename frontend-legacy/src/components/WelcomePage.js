    ...
    >
      ...
      >
        <Box sx={{ pt: { xs: 0, md: 6 } }}>
          ...
          <Box sx={{ py: 2 }}>
            <Typography>
              Realm of Darkness is redefining the way you play World of Darkness
              TTRPGs on Discord, with bots for all major versions of the game.
            </Typography>
          </Box>
          <ButtonGroup
            variant="outlined"
          ...
          >
            ...
            <Button component={Link} to="20th/">
              20th Anniversary
            </Button>
            <Button component={Link} to="cod/">
